                ...
                <header className="header-area formobile-menu header--fixed default-color">
                    <div className="header-wrapper" id="header-wrapper">
                        <div className="header-left">
                            <div className="logo">
                                <a href="/">
                                    <img className="logo-1" src="/assets/images/logo/ATT logo.png" width={145} alt="Logo Images"/>
                                    <img className="logo-2" src="/assets/images/logo/ATT logo.png" width={145} alt="Logo Images"/>
                                </a>
                            </div>
                        </div>
