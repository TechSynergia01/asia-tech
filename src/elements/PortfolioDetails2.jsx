              ...
              <div className="col-lg-12">
                <div className="section-title service-style--3 text-center mb--25 mb_sm--0 text-justify">
                  ...
                  <p style={{ padding: "unset" }}>
                    Television became one of the most innovative forms of
                    entertainment ever created -- and its role has changed
                    significantly since then. This is a complete history of
                    television, who invented it, and when, including important
                    milestones in the development of TV.
                  </p>
                </div>
              </div>
            </div>
