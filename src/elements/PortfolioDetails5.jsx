                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="rn-page-title text-center pt--100">
                                    ...
                                    <p>“Home automation” refers to the automatic and electronic control of household features, activity, and appliances. </p>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-title service-style--3 text-center mb--25 mb_sm--0 text-justify">
                                    ...
                                    <p className="text-justify">Home Automation means you can easily control the utilities and features of your home via the Internet to make life more convenient and secure, and even spend less on household bills.</p>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                                ...
                                <div className="rn-pricing">
                                    <div className="pricing-table-inner">
                                        ...
                                        <div className="pricing-body">
                                            ...
                                            <li><FiCheck />Smart Door Lock</li>
                                                <li><FiCheck />Smart Bulb Socket</li>
                                    ...
                                    <div className="pricing-table-inner">
                                        ...
                                        <div className="pricing-body">
                                            ...
                                            <li><FiCheck />Smart Window Blinds</li>
                                                <li><FiCheck />Smart Thermostatic Valve</li>
                                                <li><FiCheck />Smart Plant Sensor</li>
                                                <li><FiCheck />Smart Dustbin Can</li>
                                                <li><FiCheck />Smart Security Camera</li>
                                                <li><FiCheck />Smart Power Strip</li>
                                                <li><FiCheck />Smart Alarm Clock</li>
                                            </ul>
                                        </div>
                                        <div className="pricing-footer">
                                            <a className="rn-btn" href="#pricing">Purchase Now</a>
                            ...
                            <div className="col-lg-4 col-md-6 col-12 mt--30">
                                <div className="rn-pricing">
                                    <div className="pricing-table-inner">
                                        ...
                                        <div className="pricing-body">
                                            <ul className="list-style--1 text-justify">
                                            <li><FiCheck />Smart Wall Switch</li>
                                                <li><FiCheck />Smart Vacuum Sealer</li>
                                                <li><FiCheck />Smart Coffee Maker</li>
                                                <li><FiCheck />Smart Refrigerator</li>
                                                <li><FiCheck />Smart Wine Cooler</li>
                                                <li><FiCheck />Smart Weight Scale</li>
                                                <li><FiCheck />Smart Baby Monitor</li>
