                  ...
                  <div className="pricing-table-inner">
                    <div className="pricing-body">
                      <ul className="list-style--1 text-justify">
                        ...
                        <li>
                          <FiCheck />
                          Fitness Ring with ECG Monitoring
                        </li>
                        <li>
                          <FiCheck />
                          Smart Jewelry with Emergency Alert Function
                        </li>
                        <li>
                          <FiCheck />
                          AR-Enhanced Safety Glasses
                        </li>
                        <li>
                          <br></br>
                        </li>
                  ...
                  <div className="pricing-table-inner">
                    <div className="pricing-body">
                      <ul className="list-style--1 text-justify">
                        <li>
                          <FiCheck />
                          Wearable Health Patch for Continuous Monitoring
                        </li>
                        <li>
                          <FiCheck />
                          Smart Clothing with Climate Control
                        </li>
                        <li>
                          <FiCheck />
                          Smart Glasses
                  ...
                  <div className="pricing-table-inner">
                    <div className="pricing-body">
                      <ul className="list-style--1 text-justify">
                        ...
                        <li>
                          <FiCheck />
                          Smart Running Insoles
                        </li>
                        <li>
                          <FiCheck />
                          Wearable Meditation Device
                        </li>
                        <li>
                          <FiCheck />
                        ...
                        <li>
                          <FiCheck />
                          Wearable Electrocardiogram (ECG) Patch
                        </li>
                        <li>
                          <br></br>
                        </li>
