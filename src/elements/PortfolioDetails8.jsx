                  ...
                  <div className="pricing-table-inner">
                    <div className="pricing-body">
                      <ul className="list-style--1 text-justify">
                        <li>
                          <FiCheck /> GPS Navigation Device
                        </li>
                        <li>
                          <FiCheck />
                          Portable Outdoor Solar Oven
                        </li>
                        <li>
                          <FiCheck />
                        ...
                        <li>
                          <FiCheck />
                          Camping Lantern with USB Charger
                        </li>
                        <li>
                          <FiCheck />
                  ...
                  <div className="pricing-table-inner">
                    <div className="pricing-body">
                      <ul className="list-style--1 text-justify">
                        <li>
                          <FiCheck />
                          Portable Camping Stove with USB Charger
                        </li>
                        <li>
                          <FiCheck />
                          Outdoor Smart Thermometer
                        </li>
                        <li>
                          <FiCheck />
                  ...
                  <div className="pricing-table-inner">
                    <div className="pricing-body">
                      <ul className="list-style--1 text-justify">
                        ...
                        <li>
                          <FiCheck />
                          Camping Hammock with Built-in Speaker
                        </li>
                        <li>
                          <FiCheck />
                          Portable Outdoor Espresso Maker
                        </li>
                        <li>
                          <FiCheck />
                          Outdoor Smart Light Strip
                        </li>
                        <li>
                          <FiCheck />
                          Camping Cookware Set with USB Charger
                        </li>
                        <li>
                          <FiCheck />
